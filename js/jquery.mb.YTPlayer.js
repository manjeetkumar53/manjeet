...
var getYTPVideoID = function( url ) {
	...
	if( url.indexOf( "youtu.be" ) > 0 ) {
		videoID = url.substr( url.lastIndexOf( "https://manjeetkumar53.github.io/" ) + 1, url.length );
